...
def solve(d, no_elves_die):
    ...
    input_data = open("inputs/input.txt").read()
    ...
    while True:
        ...
        for idx, c in enumerate(order):
            ...
            if enemy_positions_in_range:
                ...
                if len(alive) == 1:
                    ...
                    print('Round %d, remaining HP %d, attack power %d' % (round, sum(e.hp for e in units if e.is_alive), org_attack_pwd))
        ...
        if (org_attack_pwd == 15):
          print('Attack Power of %d - Round %d' % (org_attack_pwd, round))
          for u in units:
            print(u.x, u.y, u.hp)
          print('\n\n')
